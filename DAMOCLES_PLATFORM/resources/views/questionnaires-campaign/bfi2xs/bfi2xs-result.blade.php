    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row item-center gap-3">
            ...
            <ul class="flex flex-row gap-1 flex-wrap break-words text-sky-800">
                ...
                <li>/</li>
                <li><a>@lang('questionnaire-campaign.bfi2xs.bfi2xs')</a></li>
            </ul>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-900">
                    <p class="text-2xl font-semibold text-center">@lang('questionnaire-campaign.bfi2xs.result')</p>
                    @php
                        $questionsPerTab = 15;
                    @endphp
                    <!-- Scales results -->
                    ...
                    <div>
                        @foreach (array_chunk(trans('questionnaire-campaign.bfi2xs.question'), $questionsPerTab) as $tabQuestions)
                            <p class="italic font-semibold text-center pt-6">Here are a number of characteristics that
