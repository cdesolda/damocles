        ...
        <div class="flex flex-col sm:flex-row item-center gap-3">
            ...
            <ul class="flex flex-row gap-1 flex-wrap break-words text-sky-800">
                @if (isset($questionnaireCampaignId) && isset($questionnaireId))
                    ...
                    <li>/</li>
                    <li><a
                            href="{{ route('big-five-inventory.index', ['questionnaireCampaign' => $questionnaireCampaignId, 'questionnaire' => $questionnaireId]) }}">@lang('questionnaire-campaign.bfi2xs.bfi2xs')</a>
                    </li>
                @else
                    <li><a href="{{ route('questionnaires') }}">@lang('questionnaire-campaign.questionnaires')</a></li>
                    <li>/</li>
                    <li>@lang('questionnaire-campaign.bfi2xs.bfi2xs')</li>
                @endif
            </ul>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-900">
                    ...
                    <form class="pb-4" action="{{ route('big-five-inventory.create') }}" method="POST">
                        ...
                        <p class="text-2xl font-semibold text-center">@lang('questionnaire-campaign.bfi2xs.bfi2xsQuestionnaire')</p>
                        @php
                            $questionsPerTab = 15;
                        @endphp
                        ...
                        <div>
                            @foreach (array_chunk(trans('questionnaire-campaign.bfi2xs.question'), $questionsPerTab) as $tabQuestions)
                                ...
                                <p class="font-semibold text-center pt-4">I am someone who... </p>
