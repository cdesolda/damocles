        ...
        <div class="flex flex-col sm:flex-row item-center gap-3">
            ...
            <ul class="flex flex-row gap-1 flex-wrap break-words text-sky-800">
                @if (isset($questionnaireCampaignId) && isset($questionnaireId))
                    ...
                    <li>/</li>
                    <li><a
                            href="{{ route('susceptibility-to-persuasion-ii.index', ['questionnaireCampaign' => $questionnaireCampaignId, 'questionnaire' => $questionnaireId]) }}">@lang('questionnaire-campaign.stp-ii-b.stpIIB')</a>
                    </li>
                @else
                    <li><a href="{{ route('questionnaires') }}">@lang('questionnaire-campaign.questionnaires')</a></li>
                    <li>/</li>
                    <li>@lang('questionnaire-campaign.stp-ii-b.stpIIB')</li>
                @endif
            </ul>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-900">
                    ...
                    <form class="pb-4" action="{{ route('susceptibility-to-persuasion-ii.create') }}" method="POST">
                        ...
                        <p class="text-2xl font-semibold text-center">@lang('questionnaire-campaign.stp-ii-b.stpIIBQuestionnaire')</p>
                        @php
                            $questionsPerTab = 9;
                        @endphp
