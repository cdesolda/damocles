        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 text-sky-900">
                ...
                @if (!$users->isEmpty())
                    ...
                    <form id="saveUsersForm" action="{{ route('phishing-campaign.users-phishing-email') }}"
                        method="POST">
                        @csrf
                        @method('post')
                        ...
                        <div class="flex flex-row justify-around items-center pt-6">
                            ...
                            <div class="flex w-1/3 justify-center">
                                <x-primary-button type="submit">@lang('phishing-campaign.newPhishingCampaign.generate')</x-primary-button>
                            </div>
                        </div>
                    </form>
                @else
