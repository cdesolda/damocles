<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row item-center gap-3">
            ...
            <a href="{{ route('digital-twins.simulationResult') }}" class="cursor-pointer">
                <x-primary-button>
                    @lang('general.back')
                </x-primary-button>
            </a>
            ...
            <ul class="flex flex-row gap-1 flex-wrap break-words text-sky-800">
                ...
                <li>/</li>
                <li>@lang('general.selectRealUsers')</li>
            </ul>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 text-sky-900">
                ...
                <p class="flex text-lg font-medium text-sky-900 pb-2">
                    @lang('general.chooseRealUsersTitle'):
                </p>
                @if (!$users->isEmpty())
                    ...
                    <form id="saveUsersForm" action="{{ route('digital-twins.finalize') }}" method="POST">
                        @csrf
