<section class="text-sky-800">
    <!-- Delete training campaign -->
    <p class="text-xl font-semibold text-center">
        @lang('training-campaign.modals.delete')
    </p>
    <div class="pt-4">
        <form id="deleteForm" data-id=""
            action="{{ route('training-campaign.destroy', ['trainingCampaign' => 'id']) }}" method="POST">
            @csrf
            @method('DELETE')
            <p class="pb-4">@lang('training-campaign.modals.deleteMessage')</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButton.forEach(button => {
            button.addEventListener('click', function() {
                ...
                const actionUrl =
                    "{{ route('training-campaign.destroy', ['trainingCampaign' => 'id']) }}";
